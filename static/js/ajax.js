$(document).ready(function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function updateSentimentCounts(productId) {
            $.ajax({
                url: `/reviews/sentiment_counts/${productId}/`,
                method: 'GET',
                success: function (data) {
        ...
        updateSentimentCounts(productId);  // Initial load
        ...
        $('#submit-button').click(function (event) {
            ...
            $.ajax({
                ...
                `;
                    ...
                    updateSentimentCounts(productId);
                },
                error: function (xhr) {
